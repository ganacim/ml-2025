        ...
        try:  # let's catch keyboard interrupt
            ...
            for epoch in pbar:
                ...
                pbar.set_description(
                    f"Epoch {epoch}, loss [t/v]: {train_accuracies[-1]:0.5f}/{validation_accuracies[-1]:0.5f}"
                )
                ...
                board.log_scalars(
                    "Curves/Accuracy",
                    {"Train Accuracy": train_accuracies[-1], "Validation Accuracy": validation_accuracies[-1]},
                    epoch,
                )
