...
class CNNVAE(BaseModel):
    ...
    def add_arguments(parser):
        parser.add_argument("--init-dim", type=int, default=28, help="First hidden layer dimension")
        parser.add_argument("--neck-dim", type=int, default=8, help="Neck dimension")
...
def test(args):
    ...
    summary(model.encoder, (3, 28, 28), device="cpu")
