...
class CNNVAE(BaseModel):
    ...
    def forward(self, x):
        ...
        self._z_mu = q_mu_logsigma2[:, : self.neck_size]
        self._z_sigma2 = torch.exp(q_mu_logsigma2[:, self.neck_size :])
        ...
        z = z.reshape(self.num_channels,self.layer_dim,self.layer_dim)
...
def test(args):
    ...
    # summary(model.decoder, (3,4,4), device="cpu")
